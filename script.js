  ...
  function setCurrentRow(rowNum) {
    ...
    gameBlockEls.forEach((gameBlockEl) => {
      if (gameBlockEl.getAttribute("game-row") == rowNum) {
        ...
        gameBlockEl.classList.add("last-row");
      } else if (gameBlockEl.getAttribute("game-row") == rowNum - 2) {
        gameBlockEl.classList.remove("last-row");
      }
    });
  }
  ...
  function addColor() {
    ...
    function add(letter, state) {
      ...
      keyEls.forEach((keyEl) => {
        if (keyEl.innerText === letter.toLowerCase()) {
